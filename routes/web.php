...
Route::group(['middleware' => ['auth', 'verified'/*, 'approved'*/]], function () {
  ...
  Route::group(['middleware' => 'can:Admin, App\Models\User'], function () {
    ...
    Route::group(['as' => 'panels.'], function () {
      ...
      Route::get("/panel/{panel}/all/agents", "PanelController@allAgents")->name('panel.all.agents');
    });
    ...
    Route::group(['middleware' => 'can:notInstaller, App\Models\User'], function () {
      Route::prefix('accounting')->group(function () {
        ...
        Route::post('/create/invoices/delete/all', 'AccountingCreateInvoicesController@deleteAll');
        Route::get('/installer-points', 'AccountingInstallerPointsController@index');
        Route::post('/installer-points/create', 'AccountingInstallerPointsController@store');
        Route::get('/installer-points/get/{installer_point}', 'AccountingInstallerPointsController@getInstallerPoint');
        Route::patch('/installer-points/update/{installer_point}', 'AccountingInstallerPointsController@update');
        Route::delete('/installer-points/delete/{installer_point}', 'AccountingInstallerPointsController@destroy');
        Route::post('/installer-points/process-payment', 'AccountingInstallerPointsController@processPayment');
      });
    });
  ...
  //Accounting (General routes for Office and Agents)
  Route::group(['middleware' => 'can:notInstaller, App\Models\User'], function () {
    Route::prefix('accounting')->group(function () {
