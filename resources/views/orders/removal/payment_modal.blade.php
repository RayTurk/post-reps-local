            ...
            <div class="modal-body">
                <form action="{{ url('/payment/removal/pay') }}" id="removalPaymentForm" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-2" id="admin_removal_office_select_section">
                            <label class="text-primary font-px-18"><strong>Select Office</strong></label>
                            <select id="admin_removal_office_select" class="form-control">
                                <option value="">-- Select Office --</option>
                            </select>
                        </div>
                        <div class="col-12 mb-2" id="admin_removal_agent_select_section">
                            <label class="text-dark"><strong>Select Agent (optional)</strong></label>
                            <select id="admin_removal_charge_agent_select" class="form-control">
