        ...
        <div class="row ">
            ...
            <div class="col-md-7">
                <div class="card auth-card">
                        @include('orders.removal.card_header')
                    <div class="card-body">
                        <div class="table-responsive">
                            @include('orders.removal.order_table')
        ...
        <div class="row ">
            ...
            <div class="col-md-8">
                <div class="card auth-card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            @include('orders.removal.order_table_tablet')
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row ">
            ...
            <div class="col-12 p-4">
                <div class="card auth-card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            @include('orders.removal.order_table_mobile')
