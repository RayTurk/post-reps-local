...
@section('content')
            ...
            <div class="col-md-10">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3" >
                        ...
                        <select id="installerSelect" id="" class="form-control width-px-274" data-installers="{{json_encode($installers)}}">
                        ...
                        <div
                            ...
                            class="mt-1 pl-3 height-px-680 pr-0 width-px-274"
    ...
    <div id="installCardTmpl" style="display:none">
        <div class="row auth-card font-px-12 width-px-274 height-px-64 mb-1" >
            ...
            <div class="col-10 py-1">
                <span class="text-success-dark font-weight-bold">Install - post_name</span><br>
                <span>replace_address</span><br>
                <span>agent_office</span>
            </div>
        </div>
    </div>
    <div id="repairCardTmpl" style="display:none">
        <div class="row auth-card font-px-12 width-px-274 height-px-64 mb-1" >
            ...
            <div class="col-10 py-1">
                <span class="text-primary-dark font-weight-bold">Repair - post_name</span><br>
                <span>replace_address</span><br>
                <span>agent_office</span>
            </div>
        </div>
    ...
    <div id="removalCardTmpl" style="display:none">
        <div class="row auth-card font-px-12 width-px-274 height-px-64 mb-1" >
            ...
            <div class="col-10 py-1">
                <span class="text-danger font-weight-bold">Removal - post_name</span><br>
                <span>replace_address</span><br>
                <span>agent_office</span>
            </div>
        </div>
    ...
    <div id="deliveryCardTmpl" style="display:none">
        <div class="row auth-card font-px-12 width-px-274 height-px-64 mb-1" >
            ...
            <div class="col-10 py-1">
                <span class="text-orange font-weight-bold">Delivery - post_name</span><br>
                <span>replace_address</span><br>
                <span>agent_office</span>
            </div>
        </div>
