...
<div id="rowTmplInstallAdjustment" style="display:none;">
    <div class="row mb-2">
        ...
        <div class="col-12 col-md-3 input-group">
            ...
            <input type="number" name="install_price_adjustment_charge[rowCount]" class="form-control charges text-right" aria-describedby="dollar-symbol">
        </div>
        <div class="col-12 col-md-3 input-group">
            <div class="input-group-prepend">
                <span class="input-group-text px-2" id="dollar-symbol">$</span>
            </div>
            <input type="number" name="install_price_adjustment_discount[rowCount]" class="form-control discounts text-right" aria-describedby="dollar-symbol">
        </div>
    </div>
</div>
