    ...
    <div class="container-fluid pl-4 mt-1 pr-4 desktop-view hide-on-tablet">
        <div class="row ">
            <div class="col-md-3 menu-bar-single pb-3">
                @include('orders.agent.removal.order_bar_removal')
            </div>
            <div class="col-md-7">
                <div class="card auth-card">
                        @include('orders.agent.removal.card_header')
                    <div class="card-body">
                        <div class="table-responsive">
                            @include('orders.agent.removal.order_table')
        ...
        <div class="row ">
            ...
            <div class="col-md-8">
                <div class="card auth-card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            @include('orders.agent.removal.order_table_tablet')
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row ">
            ...
            <div class="col-12 p-4">
                <div class="card auth-card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            @include('orders.agent.removal.order_table_mobile')
