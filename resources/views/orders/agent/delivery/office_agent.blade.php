    ...
    <div class="row">
        <div class="col-12 col-md-6 col-lg-6 mt-2">
            <div class="d-flex justify-content-start align-items-center px-2">
                ...
                <input class="form-control ml-2" type="text" id="delivery_office" disabled value="{{auth()->user()->agent->office->user->name}}">
            </div>
        </div>
        <div class="col-12 col-md-6 col-lg-6 mt-2">
            <div class="d-flex justify-content-start align-items-center px-2">
                <input type="hidden" id="officeId" value="{{auth()->user()->agent->office->id}}">
                <input type="hidden" id="agentId" value="{{auth()->user()->agent->id}}">
                <label for="delivery_agent" class="text-dark m-0"><b>AGENT: </b></label>
                <input class="form-control ml-2" type="text" id="delivery_agent" disabled value="{{auth()->user()->agent->user->name}}">
