...
@section('content')
        ...
        <div class="row ">
            ...
            <div class="col-md-10">
                ...
                <div class="card auth-card">
                    @include('orders.office.status.card_header')
                    <div class="card-body">
                        <div class="table-responsive">
                            @include('orders.office.status.order_table')
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row ">
            ...
            <div class="col-12  p-4">
                ...
                <div class="card auth-card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            @include('orders.office.status.order_table_mobile')
                        </div>
                    </div>
                </div>
            </div>
    ...
    @include('orders.office.repair.order_modal')
    @include('orders.office.repair.rush_order_modal')
    @include('orders.office.repair.payment_modal')
    @include('orders.office.repair.pricing_adjustment_modal')
    ...
    @include('orders.office.delivery.order_modal')
    @include('orders.office.delivery.payment_modal')
    @include('orders.office.delivery.rush_order_modal')
    @include('orders.office.delivery.pricing_adjustment_modal')
...
@section('page_scripts')
    ...
    <script src="{{ mix('/js/office-repair-order.js') }}" defer></script>
    <script src="{{ mix('/js/office-delivery-order.js') }}" defer></script>
@endsection
