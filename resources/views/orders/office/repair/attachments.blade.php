...
<div class="px-4">
    <div class="row">
        <div class="col-12 mt-1">
            <input type="file" multiple name="repair_order_files[]" class="d-none" id="repair_order_files">

            <ul id="files_list_repair">
                {{-- <li><span><a href="#"><strong>filename.png</strong></a>[UPLOADED 9/6/2021 1:32PM] <a href="#"><strong>[REMOVE]</strong></a></span></li> --}}
            </ul>
            <strong><label for="repair_order_files" id="uploadOtherDocRepair"
