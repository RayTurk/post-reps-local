        ...
        <div class="modal-content auth-card">
            ...
            <div class="modal-body">
                <form action="{{ url('/payment/removal/pay') }}" id="removalPaymentForm" method="post">
                    ...
                    <div class="row">
                        <div class="col-12 mb-2" id="removal_charge_source_section">
                            <label class="text-primary font-px-18"><strong>Charge Card From</strong></label>
                            <select id="removal_charge_source_select" class="form-control">
                                <option value="office" selected>Office Card</option>
                                <option value="agent">Agent Card</option>
                            </select>
                        </div>
                        <div class="col-12 mb-2" id="removal_agent_select_section" style="display:none;">
                            <label class="text-dark"><strong>Select Agent</strong></label>
                            <select id="removal_charge_agent_select" class="form-control">
                        ...
                        <div class="row mx-4 form-another-card">
                            ...
                            <div class="col-12 mb-2">
                                <div class="row">
                                    <div class="col-12">
                                        <label for="removal_billing_name" class="text-dark">
