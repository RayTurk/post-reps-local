                ...
                <div class="col-12 mt-2">
                    <div class="d-flex justify-content-start align-items-center px-2">
                        <input type="radio" value="asap" class="form-control w-h-px-25 mr-2 cursor-pointer"
                            name="removal_order_desired_date" id="desiredDate" removal-rush-order-fee="{{ $serviceSettings->removal_rush_order }}">
                        <label for="desired_date" class="text-dark m-0">
                            <b>Rush Order Request (<span>${{ $serviceSettings->removal_rush_order ?? 0}}</span>)</b>
                        </label>
                    </div>
                </div>
                <div class="col-12 mt-2">
                    <div class="d-flex justify-content-start align-items-center px-2">
                        <input type="radio" checked value="custom_date" class="form-control w-h-px-25 mr-2 cursor-pointer"
                            name="removal_order_desired_date" id="customDate">
                        <label for="custom_date" class="text-dark m-0"><b>Specify a Desired Date</b></label>
                    </div>
                    <input type="text" readonly name="removal_order_custom_desired_date"
                        class="form-control form-control-sm mt-4 width-px-120 d-none" id="removalDatepicker"></p>

                </div>
            </div>
        </div>
        <div>
            <div id="removalOrderDatePicker"></div>
        </div>
    </div>
</div>
