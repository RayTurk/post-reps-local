...
<body class="py-5" style="background-color: #f8fafc !important;">
    ...
    <div class="container p-3" style="background-color: #fff;">
        <p>
            ...
            until you have completed the order. Often times this is due to payment not being processed correctly or your payment method has been declined.
			Please check your order promptly to prevent any delays in your service.<br>
            Login to <a href="{{ env('APP_URL') }}" class="link">www.postreps.com</a> at your
            earliest convenience and update your order so that we can get this order scheduled.<br>
        ...
        <hr>
        <p>This is an auto generated email, DO NOT REPLY TO THIS EMAIL, replies will not be received. </p>
    </div>
