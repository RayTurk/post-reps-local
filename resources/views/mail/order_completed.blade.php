...
<body class="py-5" style="background-color: #f8fafc !important;">
    ...
    <div class="container p-3" style="background-color: #fff;">
        ...
        <p>
            For further infomation, you can verfiy the status and order details by clicking the link below. <br>
            <a href="{{ env('APP_URL') }}/order/status/history">Order History</a>
        </p>
        ...
        <hr>
        <p>This is an auto generated email, Do not try reply to this email, replies are not be received. if you need to
