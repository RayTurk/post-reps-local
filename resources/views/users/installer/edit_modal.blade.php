...
<!-- Modal -->
<form id="editInstallerForm" method="POST" action="{{ url('installer/update') }}" >
    @csrf
    <div class="modal fade" id="editInstallerFormModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content auth-card">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Installer</h5>
                            ...
                            <div class="form-group">
                                <div>
                                    ...
                                    <input type="color" id="routing_color" tabindex="9"
                                        class="width-px-55 form-control @error('routing_color') is-invalid @enderror"
                                        name="routing_color"
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="editInstallerForm" value="true" class="btn btn-success"
                        id="submitEditInstallerFormButton">Save</button>
                </div>
            </div>
        </div>
    </div>
