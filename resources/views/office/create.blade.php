        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card auth-card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('offices.store') }}" files=true enctype="multipart/form-data" >
                            @csrf
                            <div class="row mt-1">
                                            ...
                                            <select id="state" class="form-control  @error('state') is-invalid @enderror"
                                                ...
                                                @if (count($states))
                                                    @foreach ($states as $code => $state)
                                                        <option value="{{ $code }}" @if (old('state') === $code) selected @endif>
                                                            {{ $state }}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                    ...
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <select id="inactive"
                                                ...
                                                name="inactive">
                                                <option value="0" @if (old('inactive') == 0) selected @endif><b
                                    ...
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <select id="private"
                                                ...
                                                <option value="0" @if (old('private') == 0) selected @endif><b
                                                        class="text-muted">Public</b></option>
                                                <option value="1" @if (old('private') == 1) selected @endif><b
                                    ...
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <input type="file" name="logo_image" style="display: none" id="logo_image"
                                                accept="image/*" />
                                            <div class="logo_preview"><img /></div>
                                        </div>
                                    </div>
                                </div>
