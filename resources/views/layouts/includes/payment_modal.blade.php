            ...
            <div class="modal-body">
                <form action="{{ route('payments.pay') }}" id="paymentForm" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-2" id="admin_office_select_section">
                            <label class="text-primary font-px-18"><strong>Select Office</strong></label>
                            <select id="admin_office_select" class="form-control">
                                <option value="">-- Select Office --</option>
                            </select>
                        </div>
                        <div class="col-12 mb-2" id="admin_agent_select_section">
                            <label class="text-dark"><strong>Select Agent (optional)</strong></label>
                            <select id="admin_charge_agent_select" class="form-control">
