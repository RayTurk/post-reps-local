...
<div class="container">
    ...
    <p>SCHEDULED DAYS OF INSTALLATIONS <br>
    PostReps will generally install your sign the day that has been selected in the order form and payment has been processed. This service only pertains to standard residential orders placed on-line before 5 PM Monday through Friday. Service guarantees do not apply to extended coverage areas. An Extended Coverage area is defined as any zone or area that incurs a trip fee. In some situations, such as, but not limited to, road conditions, equipment failure, construction, inability to find property, or other situations may prevent installation a post install may be delayed until access to the property can be secured. Agent is responsible to make sure address, gate codes, and access to the property are coordinated and noted in the order. If PostReps has to reschedule a visit due to inaccurate information being provided in the order or spends more than 10 min having to locate a property, Agent understands that the service may be delayed and that an additional fee of up to 100% of the cost of the original service, may be applied to the cost of the order, at PostReps sole discretion. </p>
    ...
    <p>RENEWAL AND ADDITIONAL FEES <br>
    Customer understand that after every 90 day period, PostReps will charge a renewal fee for PostReps products that are in the field. This renewal fee will be automatically processed and billed to the customer within 10 days following the renewal period. Customer also understands that there is a fee for removal of any post that has been installed. If agent moves post to another property, agent understands there will be a penalty charged for change of address up to the cost of another installation. Agents are NOT to move a post from one property to another without written permission for such a request. </p>
	
	<p>LOST OR DAMAGED POSTREPS EQUIPMENT <br>
    At any time should any property of PostReps such as posts, flyer boxes, solar lights, hardware, and so forth, be damaged or lost while at an agents property or listing, Agent understands and agrees to be fully responsible for all costs associated with replacement of such item(s). It is the responsibility of the customer to report all damage as soon as it is discovered. </p>
    ...
    On occasion, PostReps does expose sprinkler or other private lines. When a line is exposed they may become damaged. PostReps will generally repair any damages on the spot. If, however, PostReps is not aware of damage, it is the responsibility of the agent to notify PostReps BEFORE any repairs are ordered. PostReps reserves the right to inspect the damage within 72 hours of notification and verify the damage was caused by us. PostReps will not be held responsible, financially or otherwise, for any equipment purchased, or repairs made, without our having inspected the damage first. PostReps reserves the sole right to perform, on its own, or hire a professional of PostReps choice to complete any repairs for damage caused by PostReps. PostReps is not responsible for the results of repair work done by a thrid party service. PostReps is NOT responsible for costs for repair work done by a third-party selected by the agent OR homeowner without prior approval from PostReps. If PostReps pays for services rendered, PostReps reserves the right to claim ALL tools or equipment that customer was reimbursed for. IF A HOMEOWNER OR AGENT SPECIFY A SPECIFIC LOCATION FOR A POST TO BE INSTALLED THAT RESULTS IN ANY DAMAGE TO A SPRINKLER LINE OR OTHER WIRE, THE HOMEOWNER/AGENT AGREE TO BE FULLY RESPONSIBLE FOR ANY AND ALL COSTS ASSOCIATED WITH SUCH A REPAIR.</p>
