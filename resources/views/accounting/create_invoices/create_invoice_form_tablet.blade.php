        ...
        <div class="col-sm-6">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="process_all_accounts"
                    id="allAccountsRadioTablet" value="1" checked>
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="process_all_accounts"
                    id="individualAccountRadioTablet" value="0">
