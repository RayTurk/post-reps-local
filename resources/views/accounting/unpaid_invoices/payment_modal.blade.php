                ...
                <form action="{{ url('/accounting/unpaid/invoices/payment') }}" id="invoicePaymentForm" method="post">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active font-px-16 font-weight-bold" id="check-tab"
                            data-toggle="tab" href="#check" role="tab" aria-controls="check"
                            aria-selected="true" pay-method="check">Pay With Check</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link font-px-16 font-weight-bold" id="card-tab" data-toggle="tab" href="#card"
                             role="tab" aria-controls="card" aria-selected="false" pay-method="card">Pay With Card</a>
                        </li>
                    </ul>

                    <div class="tab-content">
                        <div class="tab-pane active pt-4" id="check" role="tabpanel" aria-labelledby="check-tab">
                            <div class="row">
                                <div class="col-12 mb-3">
                                    <label for="check_number" class="text-dark">
                                        <strong>Check #</strong>
                                    </label>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    id="amount" class="form-control col-4 text-right" required autocomplete="off">
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="comments" class="text-dark">
                                        <strong>Comments</strong>
                                    </label>
                                    <textarea rows="4" name="comments" id="comments" class="form-control w-100"></textarea>
                                </div>
                        ...
                        <div class="tab-pane pt-2" id="card" role="tabpanel" aria-labelledby="card-tab">
                            <div class="row">
                                <div class="col-12 mb-3">
