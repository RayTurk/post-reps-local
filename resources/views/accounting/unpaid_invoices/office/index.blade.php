...
@section('content')
                ...
                <div class="card auth-card mt-1">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            @include('accounting.unpaid_invoices.office.unpaid_invoices_table')
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row ">
            <div class="col-12 pb-3">
                ...
                <div class="card auth-card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            @include('accounting.unpaid_invoices.office.unpaid_invoices_table_mobile')
                        </div>
                    </div>
                </div>
            </div>
    ...
    @include('accounting.unpaid_invoices.office.payment_modal')
    @include('accounting.unpaid_invoices.office.invoice_adjustment_modal')
...
@section('page_scripts')
    <script src="{{ mix('/js/office-accounting-unpaid-invoices.js') }}" defer></script>
