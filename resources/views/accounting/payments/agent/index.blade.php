...
@section('content')
                ...
                <div class="card auth-card mt-1">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            @include('accounting.payments.agent.payments_table')
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row ">
            <div class="col-12 pb-3">
                ...
                <div class="card auth-card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            @include('accounting.payments.agent.payments_table_mobile')
                        </div>
                    </div>
                </div>
            </div>
    ...
    @include('accounting.payments.agent.export_to_csv_modal')
    @include('accounting.payments.agent.export_to_excel_modal')
    @include('layouts.includes.order_details_modal')

@endsection

@section('page_scripts')
    <script src="{{ mix('/js/agent-accounting-payments.js') }}" defer></script>
