                            ...
                            @foreach ($cards as $key => $card)
                                <div class="row mb-3 mt-1">
                                    ...
                                    <div class="col-md-2 text-center">
                                        <label class="switch">
                                            <input type="checkbox"
                                                name="add_card_visible_to_agents"
                                                {{$card['visibleToAgents'] ? 'checked' : ''}}
                                                class="card-visible-to-agents"
                                                data-payment-profile-id="{{$key}}"
                                            >
                ...
                <div class="card auth-card">
                    ...
                    <div class="card-body">
                        ...
                        @if (isset($cards))
                            @foreach ($cards as $key => $card)
                                <div class="row mb-3">
                                    <div class="col-12 text-center mt-4 font-weight-bold">
                                        <span>{{ $card['cardType'] }}: {{ $card['cardNumber'] }} exp {{ $card['expDate'] }}</span>
                                    </div>
                                    <div class="col-12 text-center mt-4 font-weight-bold">
                                        Visible to Agent:
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-6 col-9">
                                            <label class="text-dark">
                                                <strong>Card Visible to All Agents</strong>
                                            </label>
                                        </div>
                                        <div class="col-md-2 col-3 pl-0">
                                            <label class="switch">
                                                <input type="checkbox" name="add_card_visible_to_agents">
                                                <span class="slider"></span>
                                            </label>
                                        </div>
                                    </div>
